	        ...
	        success:function(data){
	            ...
	            htmlresult += 
	              "<li id='each-order-details'>"+
	                ...
	                +"<input type='show' value="+e.id_reward+" class='order-reward_id'>"
	                +"<input type='show' value="+e.email+" class='order-email'>"
	                +"<input type='show' value="+e.firstname+" class='order-firstname'>"
	                +"<input type='show' value="+e.lastname+" class='order-lastname'>"
	                +"<input type='show' value="+e.credits+" class='order-credits'>"
	                +"<input type='show' value="+e.id_customer+" class='order-customer_id'>"
	                +"<input type='show' value="+e.product_name+" class='order-product_name'>"
	                +"<input type='show' value="+e.reference+" class='order-reference'>"
	                +"<input type='show' value="+e.id_order+" class='order-order_id'>"
	                +"<input type='show' value="+e.product_id+" class='order-product_id'>"
	                +"<input type='show' value="+1+" class='is_device'>"
	                +"<input type='show' value="+e.product_id+" class='order-product_id'>"
	                +"<input type='show' value="+e.total_paid_tax_incl+" class='order-total_paid'>"
	                +"<input type='show' value="+data['staff'][0].name+" class='shopname'>"
	                +"<input type='show' value="+data['staff'][0].shop_id+" class='shop_id'>"
	                +"<input type='show' value="+new Date().toISOString().slice(0, 19).replace('T', ' ')+" class='current_date'>"

	                +"<input type='show' value="+0+" class='pos_credits'>"
	                +"<input type='show' value="+0+" class='pos_reward_id'>"
